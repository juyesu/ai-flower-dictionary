...
const ScrollButton = () => {
  ...
  return (
    <div className='cursour-poiner fixed z-50 flex flex-col items-center rounded-xl border bg-zinc-400 opacity-70 dark:border-gray-400 dark:bg-gray-600 mobile:bottom-6 mobile:right-6 sm:bottom-8 sm:right-10'>
      ...
      >
        <ArrowUp className='fill-white mobile:h-5 mobile:w-4 sm:h-6 sm:w-5' aria-hidden='true' />
      </button>
      <button
        type='button'
      ...
      >
        <ArrowDown className='fill-white mobile:h-5 mobile:w-4 sm:h-6 sm:w-5' aria-hidden='true' />
      </button>
    </div>
  )
}
