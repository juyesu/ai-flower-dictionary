...
const Modal = ({ onClose, bgOverlay, secoundButton, message }: ModalProps) => {
  ...
  return (
    <>
      {bgOverlay && (
        <div
          className="fixed z-0 h-full w-full bg-white bg-opacity-90 dark:bg-zinc-900 dark:bg-opacity-80"
          onClick={onClose}
          aria-hidden="true"
        />
      )}
      <div
        ...
        className="z-99 fixed top-[32rem] flex w-[420px] items-center justify-center rounded-2xl bg-white opacity-100 shadow-lg dark:bg-zinc-700"
      >
